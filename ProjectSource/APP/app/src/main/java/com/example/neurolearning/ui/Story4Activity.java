...
public class Story4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_story4); // Story3 레이아웃
    ...
    private void showInitialScreen() {
        ...
        View initial = LayoutInflater.from(this)
                .inflate(R.layout.activity_start_story4, contentFrame, false); // Story3 시작 레이아웃
        ...
        btn.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(Story4Activity.this, /* Story3Game */DirectionGameActivity.class);
            // 사용자 정보 전달 (추가)
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == REQ_GAME && resultCode == RESULT_OK) {
            ...
            gameProgressRepository.saveGamePlayRecord(
                    currentUsername,
                    currentStoryNumber,
                    "STORY4_GAME", // Story3에 맞는 게임 타입으로 변경
                    score,
                    true,
                    0,
    ...
    private void showEndScreen() {
        ...
        View end = LayoutInflater.from(this)
                .inflate(R.layout.activity_end_story4, contentFrame, false); // Story3 종료 레이아웃
